/**
 * Interfaz que almacena la base de conocimiento para el Chatbot
 *
 */
public interface BaseConocimiento {
    String baseConocimiento[][][] = {
		{{"WHAT IS YOUR NAME"}, 
			{"MY NAME IS GAMERBOT.",
			 "YOU CAN CALL ME GAMERBOT.",
			...
			{"HELLO USER, WHAT IS YOUR NAME?",
			 ...
			 "YOU ARE NOW CHATING WITH GAMERBOT, ANYTHING YOU WANT TO DISCUSS?"}
			},
			...
			{{"NINTENDO"},
			{"THE LEGEND OF ZELDA IS A GOOD SERIES.",
			 "YOU SHOULD BUY AMIIBOS.",
			 "DO YOU HAVE A WII?",
			 "SUPER MARIO BROS IS A GOOD PLATFORMING GAME."}
			},
			
			{{"WII"},
			{"WII U IS DEAD.",
			 "I LOVE SUPER SMASH BROS!",
			 "YOU SHOULD PLAY BAYONETTA 2."}
			},
			
			{{"ZELDA"},
			{"MY FAVOURITE ZELDA GAME IS MAJORA'S MASK.",
			 "NINTENDO IS GOING TO RELEASE A NEW ZELDA GAME THIS YEAR.",
			 "HAVE YOU PLAYED ALL OF THE ZELDA GAMES?"}
			},
			
			{{"STEAM"},
			{"HALF LIFE 3 IS NEVER COMING OUT.",
			 "THE WITCHER IS GOOD FANTASY GAME. YOU SHOULD PLAY IT.",
			 "GOAT SIMULATOR GAME OF THE YEAR!"}
			},
			
			{{"SONY"},
			{"PLAYSTATION 4 IS A GOOD CONSOLE.",
			 "DO YOU HAVE A PLAYSTATION?",
			 "THE LAST OF US IS REALLY COOL."}
			},
			
			{{"XBOX"},
			{"I LIKE HALO GAMES.",
			 "DO YOU HAVE AN XBOX?",
			 "YOU SHOULD PLAY GEARS OF WAR."}
			},
	
			{{"PLAYSTATION"},
			{"BLOODBORNE IS HARD BUT COOL",
			"THE LAST GUARDIAN IS FINALLY GOING TO BE RELEASED.",
			"FINAL FANTASY VII REMAKE!!!!!"}
			},
			
			{{"ACTION"},
			{"BLOODBORNE IS HARD BUT COOL.",
			 "INFAMOUS IS A GOOD ACTION GAME.",
			 "THE LAST OF US IS REALLY COOL."}
			},
			
			{{"FIGHTING"},
			{"STREET FIGHTER IS REALLY COOL.",
			 "I THINK YOU SHOULD PLAY SOME TEKKEN.",
			 "SUPER SMASH BROS IS A REALLY GOOD FIGHTING GAME."}
			},
			
			{{"SHOOTER"},
			{"I LIKE HALO GAMES.",
			 "COUNTER STRIKE IS A GOOD SHOOTER GAME.",
			 "BIOSHOCK IS A GOOD UNDERWATER SHOOTER."}
			},
			
			{{"RACING"},
			{"MARIO KART IS THE BEST.",
			 "GRAN TURISMO IS OKAY.",
			 "FORZA IS THE BEST XBOX RACING GAME."}
			},
			
			{{"INDIE"},
			{"MINECRAFT IS VERY FAMOUS.",
			 "UNDERTALE IS A VERY GOOD RPG.",
			 "THE BINDING OF ISAAC IS VERY ADDICTING."}
			}
		};
		
		String listaTranspuestos[][] = {
			{"I'M", "YOU'RE"},
			{"AM", "ARE"},
			{"WERE", "WAS"},
			{"ME", "YOU"},
